...
class Report:
    ...
    def __most_dangerous(self, data: list):
        ...
        str_ = f'''наиболее опасным сценарием является сценарий полного разрушения С1_1_tmax для обрудования: {dev.split()[0].replace(',', '')} с вероятностью возникновения {frequency} 1/год при метеоусловиях:  скорость ветра 1 м/с, температура воздуха воздуха 39 град.С. Ущерб при реализации данного сценария составляет: {dmg} млн.руб'''
        return str_
